      ...
      <div>
        ...
        >
          ...
          >
            ...
            <button
              className="grid w-10 h-10 rounded-full opacity-50 place-items-center hover:bg-gray-500/10"
            ...
            {!collapsed && (
              <>
                ...
                {session && (
                  ...
                  <a
                    onClick={() => signOut()}
                    className="flex items-center gap-3 px-3 py-3 text-sm transition-colors duration-200 rounded-md cursor-pointer text-white hover:bg-gray-500/10"
                  >
                    <svg
                      stroke="currentColor"
                      fill="none"
