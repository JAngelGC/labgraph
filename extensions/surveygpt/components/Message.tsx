...
const Message = ({
  ...
  return (
    <div className={`py-5 text-color-gray ${"bg-[#E8EAEC]"}`}>
      <div className='flex max-w-2xl px-10 mx-auto space-x-5'>
        ...
        <div style={{ width: `60%`, overflowX: 'auto' }}>
          <ReactMarkdown className='pt-1 text-sm ' >{message}</ReactMarkdown>
        </div>
      </div>
      <div>
        {(
          <div className="flex justify-end max-w-2xl px-10 mx-auto">
            ...
            <button className="mx-2 hover:text-blue-500" >
              <svg stroke="currentColor" fill={message ? "currentColor" : "none"} stroke-width="2" viewBox="0 0 24 24" stroke-linecap="round" stroke-linejoin="round" className="w-4 h-4" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><path d="M14 9V5a3 3 0 0 0-3-3l-4 9v11h11.28a2 2 0 0 0 2-1.7l1.38-9a2 2 0 0 0-2-2.3zM7 22H4a2 2 0 0 1-2-2v-7a2 2 0 0 1 2-2h3"></path></svg>
            </button>
            <button className="mx-2 hover:text-blue-500" >
              <svg stroke="currentColor" fill={message ? "currentColor" : "none"} stroke-width="2" viewBox="0 0 24 24" stroke-linecap="round" stroke-linejoin="round" className="w-4 h-4" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><path d="M10 15v4a3 3 0 0 0 3 3l4-9V2H5.72a2 2 0 0 0-2 1.7l-1.38 9a2 2 0 0 0 2 2.3zm7-13h2.67A2.31 2.31 0 0 1 22 4v7a2.31 2.31 0 0 1-2.33 2H17"></path></svg>
            </button>
          </div>
        )}
      </div>
